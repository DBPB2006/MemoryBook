                ...
                <div class="lg:hidden mb-8 enhanced-backdrop p-4 bg-[#d1c7eb]">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-2">
                        <a href="add_friend.php"
                            class="bg-[#8B7EC8] text-white p-4 rounded-xl hover:bg-[#7A6BB5] transition-all duration-300 text-center">
                            <i class="fas fa-user-plus w-7 h-7 mb-2"></i>
                            <span class="text-sm font-medium">Add Friend</span>
                        </a>
                        <a href="add_memory.php"
                            class="bg-[#A8C8EC] text-white p-4 rounded-xl hover:bg-[#8BB4E0] transition-all duration-300 text-center">
                            <i class="fas fa-plus w-7 h-7 mb-2"></i>
                            <span class="text-sm font-medium">Create Memory</span>
                        </a>
                        <a href="friendship_map_of_memories.php?view=network"
                            class="bg-[#E6F1FB] text-[#8B7EC8] p-4 rounded-xl hover:bg-[#D1C7EB] transition-all duration-300 text-center">
                            <i class="fas fa-project-diagram w-7 h-7 mb-2"></i>
                            <span class="text-sm font-medium">Network of Friends</span>
                        </a>
                        <a href="friendship_map_of_memories.php?view=map"
                            class="bg-[#F4A6A6] text-white p-4 rounded-xl hover:bg-[#F18C8C] transition-all duration-300 text-center">
                    ...
                    <div class="space-y-4">
                        ...
                        if (empty($recentFriends)) {
                            ...
                            foreach ($recentFriends as $f) {
                                ...
                                if ($added)
                                    echo ' <span class="text-xs text-[#8B7EC8]">(' . $added . ')</span>';
                                echo '</p>';
                                echo '</div>';
                                echo '</div>';
                            }
