    ...
    <form id="memoryForm" class="grid lg:grid-cols-2 gap-8" method="POST" enctype="multipart/form-data">
        <div class="order-2 lg:order-1">
            ...
            <div class="bg-white rounded-2xl p-6 shadow">
                ...
                <div class="relative">
                    <input type="text" id="location" name="location" class="w-full px-4 py-3 border border-[#E8E3F5] rounded-lg focus:ring-2 focus:ring-[#8B7EC8]" placeholder="Where did this memory happen?" autocomplete="off">
                    <i class="fas fa-map-marker-alt absolute right-3 top-4 text-[#6B6B7D]"></i>
                    <div id="locationSuggestions" class="absolute z-10 w-full bg-white border border-[#E8E3F5] rounded-lg shadow-lg mt-1 hidden max-h-48 overflow-y-auto"></div>
                </div>
            </div>
        </div>
